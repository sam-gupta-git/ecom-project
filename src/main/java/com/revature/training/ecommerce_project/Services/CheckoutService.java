...
public class CheckoutService {
    ...
    public void calculateTotal(String userID) {
    ...
    public void calculateTaxes(String userID) {
        
    }

    public void calculateShippingCost(String userID) {
    ...
    public void getCheckoutSummary(String userID) {
